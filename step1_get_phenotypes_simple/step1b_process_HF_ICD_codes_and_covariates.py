...
# ICD-10: I11.0, I13.0, I13.2, I25.5, I42.0, I42.5, I42.8, I42.9, I50.0, I50.1, I50.9
all_HF = ["counts_" + ICD for ICD in ["I110", "I130", "I132", "I255", "I420", "I425", "I428", "I429", "I500", "I501", "I509"]]
...
X_data = pd.concat([X_eids, X_ICD_main.reindex(X_eids.index)], axis=1)
...
HF_correlations = []
p_vals = []
for ycol in y_data.to_numpy(dtype = float).T:
    correlation_set = []
    p_val_set = []
