...
df_main.columns = ["task", "SNP hit model E[-log10(p)]", "alt model E[-log10(p)]", "null E[-log10(p)]", "p_diff alt minus null"]
df_main.to_csv("step11f_main.txt", sep = "\t", header = True, index = False)

df_smoking = pd.DataFrame(stats_GxSmoking)
df_smoking.columns = ["task", "SNP hit model E[-log10(p)]", "alt model E[-log10(p)]", "null E[-log10(p)]", "p_diff alt minus null"]
df_smoking.to_csv("step11f_smoking.txt", sep = "\t", header = True, index = False)