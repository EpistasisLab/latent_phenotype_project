#!/bin/bash
#BSUB -J step7j_compute_network_shapley_values
#BSUB -o step7j_compute_network_shapley_values.out
#BSUB -e step7j_compute_network_shapley_values.err
...
do
    ...
    printf 'python step7j_compute_network_shapley_values.py --index '$i >> $DIR'/shapley_value_computer'$i'.sh'
done
