...
# ignoring the residual indices for reasons explained below:
# The 15 phenotypes explain 99.99% of the variance in all cause HF
# At best, the residual (16th phenotype) can reasonably explain 0.01% of the variance
# Given the profound kurtosis in the residual, we expect the peculiarly large
