...
pheno_path = "../step9_regress_phenotypes_against_SNPs_logistic_PCA/QTL_phenotypes.txt"
...
eid_path = "../step9_regress_phenotypes_against_SNPs_logistic_PCA/QTL_phenotypes_eids.txt"
...
path = "../step7_adjust_HF_for_covariates_logistic_PCA/y.txt"
...
pd.DataFrame(X).to_csv("step10e_logistic_PCA_PRS.txt", sep = "\t", header = False, index = False)
